...
public class TrashCansModBlocks {
    public static final Block TRASH_CAN_BLOCK = registerBlock("trash_can", new TrashCanBlock(FabricBlockSettings.of(Material.STONE).nonOpaque().hardness(2f).resistance(6f).sounds(BlockSoundGroup.STONE)), ItemGroups.REDSTONE);
